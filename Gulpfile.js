// Generated on 2017-04-04 using generator-mendix 2.1.1 :: git+https://github.com/mendix/generator-mendix.git
/*jshint -W069,-W097*/
"use strict";
...
const paths = {
    ...
    DIST_MPK_FILE: relPath(`./dist/${pkg.version}/${pkg.name}.mpk`),
    DIST_WIDGET_FOLDER: relPath(pkg.paths.testProjectFolder, 'widgets/'),
    DIST_DEPLOYMENT_FOLDER: relPath(pkg.paths.testProjectFolder, 'deployment/web/widgets'),
    PACKAGE_XML: relPath('./src/package.xml'),
    TEST_PATH_MPR: relPath(pkg.paths.testProjectFolder, pkg.paths.testProjectFileName)
};
...
gulp.task("modeler", (cb) => {
    widgetBuilderHelper.runmodeler(MODELER_PATH, MODELER_ARGS, paths.TEST_PATH_MPR, cb);
});
